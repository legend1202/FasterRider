...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
            ...
            try {
                ...
                if(show_dialog) {
                    ...
                    if (!NotificationUtils.isAppIsInBackground(getApplicationContext())){
                        ...
                        //Log.e("ingresoforeground", "Testttttttttttttttttt" );
                        if(Activity.equals("DeliveryOrderDetail")){
    ...
    private int getNotificationIcon() {
        ...
        return useWhiteIcon ? R.drawable.ic_notification_small : R.drawable.ic_notification_small;
    }
