...
public class LoginAsDelivery extends AppCompatActivity {
    ...
    private boolean validateEmail() {
        ...
        if (email.isEmpty() || !isValidEmail(email)) {
            ...
            //Typeface type = Typeface.createFromAsset(getAssets(),"fonts/louisgeorgecafe.ttf");
    ...
    private boolean validatePassword() {
        if (edit_pwd.getText().toString().trim().isEmpty()) {
            ...
            //Typeface typeP = Typeface.createFromAsset(getAssets(),"fonts/louisgeorgecafe.ttf");
            //inputLayoutPassword.setTypeface(typeP);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (txt_success.equals("1")) {
                        ...
                        String start_date = jo_detail.getString("START_DATE");
                        String desc_levels = jo_detail.getString("DESC_LEVELS");
                        saveToSharedPref(id, level_id, name, phone, email, vehicle_no, vehicle_type, image, start_date, desc_levels);
    ...
    private void saveToSharedPref(String id, String level_id, String name, String phone, String email, String vehicle_no, String vehicle_type, String image, String start_date, String desc_levels) {
        ...
        edit.putString("DeliveryUserStartDate", start_date);
        edit.putString("DeliveryUserDescLevel", desc_levels);
        //Log.e("xxxxxxxxxxx", String.valueOf(battery));
        edit.apply();
