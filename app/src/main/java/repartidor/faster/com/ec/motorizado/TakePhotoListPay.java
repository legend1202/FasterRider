...
public class TakePhotoListPay extends AppCompatActivity {

    private String PaymentNo, deliveryBoyId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_take_photo_list_pay);
        Intent i = getIntent();
    ...
    private void initView() {
        ...
        txt_header.setText("Ver pago #"+ PaymentNo);
    ...
    private void getdetaillist() {
                    ...
                    try {
                        ...
                        if(txt_success.equals("1")) {
                            ...
                            for (int i = 0; i < ja_order.length(); i++) {
                                ...
                                getSet.setPhoto(getResources().getString(R.string.link) + getString(R.string.accountingPath) + jo_orderDetail.getString("image_name"));
                                getSet.setDetail(jo_orderDetail.getString("details"));
                                getSet.setHistoryDate(jo_orderDetail.getString("updated_payment"));
                                getSet.setStatus(jo_orderDetail.getString("status"));
                                data.add(getSet);
                                //Log.e("JSONObject", jo_orderDetail.getString("photo"));
                            }
                            TravelPhotoListAdapter adapter = new TravelPhotoListAdapter(data, TakePhotoListPay.this);
                            listView_travelhistory.setAdapter(adapter);
                        }
                        if(txt_success.equals("0")){
                            Toast.makeText(TakePhotoListPay.this, txt_message, Toast.LENGTH_SHORT).show();
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError || error instanceof NetworkError) {
                            AlertDialog.Builder builder1 = new AlertDialog.Builder(TakePhotoListPay.this, R.style.MyDialogTheme);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TakePhotoListPay.this);
